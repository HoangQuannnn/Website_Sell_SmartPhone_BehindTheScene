    ...
    public class MoKhoaTaiKhoanModel : PageModel
    {
     ...
     !ResultLockoutEnd.Succeeded)
            ...
            await _emailSender.SendEmailAsync(user.Email, "Thông báo về việc mở khóa tài khoản của bạn",
                     $"Tài khoản của bạn đã được mở khóa. Mong bạn sẽ tuân thủ điều khoản trên web chúng tôi. Chân thành xin lỗi bạn vì sự bất tiện này. Mọi thắc mắc xin vui lòng liên hệ đội ngũ hỗ trợ 0929068516.");
