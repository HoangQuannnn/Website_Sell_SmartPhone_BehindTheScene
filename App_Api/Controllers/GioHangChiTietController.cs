...
namespace App_Api.Controllers
{
    ...
    public class GioHangChiTietController : ControllerBase
    {
        ...
        public GioHangChiTietController(IAllRepo<SanPham> sanPhamRes, IAllRepo<MauSac> mauSacRes, ISanPhamChiTietRespo sanPhamChiTietRes, IMapper mapper, IAllRepo<Anh> anhRes, IAllRepo<NguoiDung> nguoiDung)
        {
